        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php" style="width: 150px;"><img alt="Brand" src="assets/img/logo1.png" height="40px"></a>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            ">
                                ...
                                <div class="col-lg-6 col-xs-6 col-md-6 col-sm-6">
                                    <div></div>
                                <a href="https://github.com/"><img src="img/a.svg.webp" height="50%"></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="hero__img">
                                <img src="img/d7.png" alt="" width="160px" height="600px">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="hero__text"
                            ...
                            <h2 style="color:#056495">Welcome to the<br /> HORUS Healthcares<br /></h2>
                                <h5 style="color:#056495"><i class="fa fa-check-circle" aria-hidden="true"></i>  &nbsp; Easy to access e-record folders</h5><br />
                                <h5 style="color:#056495"><i class="fa fa-check-circle" aria-hidden="true"></i> &nbsp; 100% Patient privacy Protection</h5><br />
                        ...
                        <div class="col-lg-6">
                            <div class="hero__img">
                                <img src="img/d2.png" alt="" width="auto" height="auto">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            style="
                             margin-top: 0px; 
                                ...
                                padding: 0;
                            ">
                                <img src="img/d6.png" alt="" width="160px" height="600px">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Hero Section End -->
     ...
     <section id="promo-1" class="content-block min-height-600px">
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small">©Horus Healthcares</p>
