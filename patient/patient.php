...
<html lang="en">
	...
	<body>
		...
		<img class="card-img-top" src="assets/img/d1.png" alt="Card image cap" height="60%" width="60%">
		<div class="card-body">
			
		<p class="h6 card-title" style="font-size: calc(30% + 1vw + 1vh);">Save <br /> Record</p>
		</div>
		</div>
		</div></a>
		...
		style="background:white;
				...
				box-shadow: 5px 10px 18px #888888;">
		<div class="card text-center" >
		<img class="card-img-top" src="assets/img/d2.png" alt="Card image cap" height="60%" width="60%">
		<div class="card-body">
		<p class="h6 card-title" style="font-size: calc(30% + 1vw + 1vh);" >Consult <br /> Doctor</p>
		</div>
		</div>
		</div></a>
		...
		<div class="card text-center" >
		<img class="card-img" src="assets/img/d3.png" alt="Card image cap" height="60%" width="60%" class="center">
		<div class="card-body">
		<p class="h6 card-title" style="font-size: calc(30% + 1vw + 1vh);">Order  <br /> Medicines</p>
		</div>
		</div>
		</div></a>
